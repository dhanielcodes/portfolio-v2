...
const LinkSection = () => {
  return (
    <div
      className={`bg-black hover:bg-[#1f1f1f] border-2 border-[#6a6a6a] transition duration-150 ease-linear   uppercase w-full row-span-1 mt-4 p-[20px] items-center h-full flex justify-around rounded-2xl text-white`}
    >
      <a href="https://daniel-adekoya.my.canva.site/" target="_blank">
